...
import {MaybeGenerate, maybeResolveProp, resolveProp} from "../../../../shs-react-redux-app/src/util/generateProp";
...
export interface Props {
    ...
    disabled?: MaybeGenerate<boolean, JoystickDirection>;
    //can pass size and color to icons
    iconProps?: MaybeGenerate<IconProps, JoystickDirection>;
}
    ...
    const renderButton = (direction: JoystickDirection, IconComponent: ComponentType<IconProps>) => {
        return (
            ...
            >
                <View>
                    <IconComponent
                        {...maybeResolveProp(iconProps, direction)}
                    />
                </View>
            </Button>
        )
